import { type FileUIPart as FileUIPartAI, type ChatStatus as ChatStatusAI } from 'ai';
import { setContext, getContext } from 'svelte';

export { type FileUIPart as FileUIPartAI } from 'ai';

export type FileWithId = FileUIPartAI & {
  id: string;
}
...
export type ChatStatus = ChatStatusAI;
